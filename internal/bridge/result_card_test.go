...
func TestResultCard_InterruptedRendersAsStopped(t *testing.T) {
	...
	card := b.resultCardWithIDAndInterrupt("proj", "abc12345", "", "sonnet", "", 0, "partial output", nil, result, true)
...
func TestResultCard_RealErrorStillRendersAsError(t *testing.T) {
	...
	card := b.resultCardWithIDAndInterrupt("proj", "abc", "", "sonnet", "", 0, "", nil, result, false)
...
func TestResultCard_SuccessUnaffected(t *testing.T) {
	...
	card := b.resultCardWithIDAndInterrupt("proj", "abc", "", "sonnet", "", 0, "all good", nil, result, false)
